...
def _build_collection_tar(
    ...
    inner_files = file_manifest["files"]  # type: t.list[t.dict[Literal['name', 'ftype', 'chksum_type', 'chksum_sha256', 'format'], str | int | None]] | int
    inner_files.sort(key=lambda x: x["name"])
    file_manifest["files"] = inner_files

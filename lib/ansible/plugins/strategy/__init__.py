        ...
        while True:
            ...
            if task_result.is_failed():
                ...
                if not ignore_errors:
                    ...
                    if original_task.run_once and original_task.any_errors_fatal:
                        # if we're using run_once, we have to fail every host here and not original_task.any_errors_fatal
